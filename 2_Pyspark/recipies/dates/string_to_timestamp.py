...
dataframe = dataframe.withColumn("timestamp-_col", F.to_timestamp(F.col("input_timestamp"))) \
    .withColumn("using_cast", F.to_timestamp(F.col("input_timestamp")).cast('string'))
